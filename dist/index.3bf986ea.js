function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},i={},a=r.parcelRequire3a11;null==a&&((a=function(e){if(e in n)return n[e].exports;if(e in i){var t=i[e];delete i[e];var r={id:e,exports:{}};return n[e]=r,t.call(r.exports,r,r.exports),r.exports}var a=Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(e,t){i[e]=t},r.parcelRequire3a11=a),a.register("kyEFX",function(t,r){e(t.exports,"register",function(){return n},function(e){return n=e}),e(t.exports,"resolve",function(){return i},function(e){return i=e});var n,i,a={};n=function(e){for(var t=Object.keys(e),r=0;r<t.length;r++)a[t[r]]=e[t[r]]},i=function(e){var t=a[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),a("kyEFX").register(JSON.parse('{"3EsVB":"index.3bf986ea.js","cPzGy":"icons.c14567a0.svg"}'));/**
...
return H()}for(o.method=r,o.arg=i;;){var a=o.delegate;if(a){var c=// Call delegate.iterator[context.method](context.arg) and handle the
...
var y={};l(y,o,function(){return this});var b=Object.getPrototypeOf,w=b&&b(b(j([])));w&&w!==r&&n.call(w,o)&&// of the polyfill.
...
this.tryEntries=[{tryLoc:"root"}],e.forEach(x,this),this.reset(!0)}function j(e){if(e){var r=e[o];if(r)return r.call(e);if("function"==typeof e.next)return e;if(!isNaN(e.length)){var i=-1,a=function r(){for(;++i<e.length;)if(n.call(e,i))return r.value=e[i],r.done=!1,r;return r.value=t,r.done=!0,r};return a.next=a}}// Return an iterator with no values.
return{next:H}}function H(){return{value:t,done:!0}}// Regardless of whether this script is executing as a CommonJS module
// or not, return the runtime object so that we can declare the variable
// regeneratorRuntime in the outer scope, which allows this module to be
// injected easily by `bin/regenerator --include-runtime script.js`.
return v.prototype=m,i(k,"constructor",{value:m,configurable:!0}),i(m,"constructor",{value:v,configurable:!0}),v.displayName=l(m,c,"GeneratorFunction"),e.isGeneratorFunction=function(e){var t="function"==typeof e&&e.constructor;return!!t&&(t===v||"GeneratorFunction"===// For the native GeneratorFunction constructor, the best we can
...
e.done=!0,e)}},e.values=j,S.prototype={constructor:S,reset:function(e){if(this.prev=0,this.next=0,// Resetting context._sent for legacy support of Babel's
...
}),u.recipe.servings=e},_=function(){localStorage.setItem("bookmarks",JSON.stringify(u.bookmarks))},v=function(e){// Add Bookmark
u.bookmarks.push(e),e.id===u.recipe.id&&(u.recipe.bookmarked=!0),_()},m=function(e){// Delete Bookmark
let t=u.bookmarks.findIndex(t=>t.id===e);u.bookmarks.splice(t,1),e===u.recipe.id&&(u.recipe.bookmarked=!1),_()};!function(){let e=localStorage.getItem("bookmarks");e&&(u.bookmarks=JSON.parse(e))}();const y=async function(e){try{let t=Object.entries(e).filter(e=>e[0].startsWith("ingredient")&&""!==e[1]).map(e=>{let t=e[1].split(",").map(e=>e.trim());// const ingArr = ing[1].replaceAll(' ', '').split(',');
if(3!==t.length)throw Error("not correct Form of INGRIDIENTS!");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,publisher:e.publisher,source_url:e.sourceUrl,image_url:e.image,servings:+e.servings,cooking_time:+e.cookingTime,ingredients:t},n=await l(`${s}?key=${c}`,r);u.recipe=d(n),v(u.recipe)}catch(e){throw e}};var b={};b=new URL(a("kyEFX").resolve("cPzGy"),import.meta.url).toString();class w{_data;render(e,t=!0){if(!e||Array.isArray(e)&&0===e.length)return this.renderError();this._data=e;let r=this._generateMarkup();if(!t)return r;this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",r)}update(e){this._data=e;let t=this._generateMarkup(),r=document.createRange().createContextualFragment(t),n=Array.from(r.querySelectorAll("*")),i=Array.from(this._parentElement.querySelectorAll("*"));n.forEach((e,t)=>{let r=i[t];e.isEqualNode(r)||e.firstChild?.nodeValue.trim()===""||(r.textContent=e.textContent),e.isEqualNode(r)||Array.from(e.attributes).forEach(e=>r.setAttribute(e.name,e.value))})}_clear(){this._parentElement.innerHTML=""}renderSpinner(){let e=`
        <div class="spinner">
            <svg>
...
return $(l,(c-1)*o,n,i,!0);//Further reduce the numerator and denominator.
    ...
    `}_generateMarkupIngredient(e){return`
                    <li class='recipe__ingredient'>
                      ...
                      `}}var x=new E;class L{_parentEl=document.querySelector(".search");getQuery(){let e=this._parentEl.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){this._parentEl.querySelector(".search__field").value=""}addHandlerSearch(e){this._parentEl.addEventListener("submit",function(t){t.preventDefault(),e()})}}var S=new L,j=new class extends w{_parentElement="";_generateMarkup(){let e=window.location.hash.slice(1);return`
           <li class='preview'>
...
1===r&&e>1?`
      ...
      `:"")}}var F=new N;const I=async function(){try{let e=window.location.hash.slice(1);if(!e)return;x.renderSpinner(),P.update(f()),O.update(u.bookmarks),// 2. Loading Recipe
await h(e),x.render(u.recipe)}catch(e){x.renderError(),console.log(e)}},R=async function(){try{P.renderSpinner();// 1. Get Search Query
let e=S.getQuery();if(!e)return;// 2. Load Search Results
await p(e),P.render(f()),F.render(u.search)}catch(e){console.log(e)}},A=async function(e){try{q.renderSpinner(),// Upload New recipe data
await y(e),console.log(u.recipe),x.render(u.recipe),q.renderMessage(),O.render(u.bookmarks),// Change id in URL
window.history.pushState(null,"",`#${u.recipe.id}`),// Closing Form window
setTimeout(function(){q.toggleWindow()},2500)}catch(e){console.error(e,"\uD83D\uDE00\uD83D\uDE00\uD83D\uDE00"),q.renderError(e.message)}};O.addHandlerRender(function(){O.render(u.bookmarks)}),x.addHandlerRender(I),x.addHandlerUpdateServings(function(e){//Update recipe servings
g(e),x.update(u.recipe)}),x.addHandlerBookmark(function(){u.recipe.bookmarked?m(u.recipe.id):v(u.recipe),x.update(u.recipe),O.render(u.bookmarks)}),S.addHandlerSearch(R),F.addHandlerRender(function(e){P.render(f(e)),F.render(u.search)}),q.addHandlerUpload(A);//# sourceMappingURL=index.3bf986ea.js.map

//# sourceMappingURL=index.3bf986ea.js.map
