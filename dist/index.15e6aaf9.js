function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},i={},a=r.parcelRequire3a11;null==a&&((a=function(e){if(e in n)return n[e].exports;if(e in i){var t=i[e];delete i[e];var r={id:e,exports:{}};return n[e]=r,t.call(r.exports,r,r.exports),r.exports}var a=Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(e,t){i[e]=t},r.parcelRequire3a11=a),a.register("27Lyk",function(t,r){e(t.exports,"register",()=>n,e=>n=e),e(t.exports,"resolve",()=>i,e=>i=e);var n,i,a={};n=function(e){for(var t=Object.keys(e),r=0;r<t.length;r++)a[t[r]]=e[t[r]]},i=function(e){var t=a[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),a("27Lyk").register(JSON.parse('{"f9fpV":"index.15e6aaf9.js","eyyUD":"icons.c14567a0.svg"}'));/**
...
(this.arg=t),f}},e}({});try{regeneratorRuntime=o}catch(e){"object"==typeof globalThis?globalThis.regeneratorRuntime=o:Function("r","regeneratorRuntime = r")(o)}const s="https://forkify-api.herokuapp.com/api/v2/recipes",c="1abccb16-ff74-471c-9c20-7f67aa7461e1",l=async function(e,t){try{let r=t?fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):fetch(e),n=await Promise.race([r,new Promise(function(e,t){setTimeout(function(){t(Error("Request took too long! Timeout after 20 second"))},2e4)})]),i=await n.json();if(!n.ok)throw Error(`${i.message} ${n.status}`);return i}catch(e){throw e}},u={recipe:{},search:{query:"",results:[],resultsPerPage:5,page:1},bookmarks:[]},d=function(e){let{recipe:t}=e.data;return{id:t.id,title:t.title,publisher:t.publisher,sourceUrl:t.source_url,image:t.image_url,servings:t.servings,cookingTime:t.cooking_time,ingredients:t.ingredients,...t.key&&{key:t.key}}},h=async function(e){try{let t=await l(`${s}/${e}?key=${c}`);u.recipe=d(t),u.bookmarks.some(t=>t.id===e)?u.recipe.bookmarked=!0:u.recipe.bookmarked=!1,console.log(u.recipe)}catch(e){throw console.error(`${e} 😂😂😂`),e}},p=async function(e){try{u.search.query=e;let t=await l(`${s}?search=${e}&key=${c}`);// console.log(data);
u.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,publisher:e.publisher,image:e.image_url,...e.key&&{key:e.key}})),u.search.page=1}catch(e){throw console.log(`${e} 😁😁😁`),Error}},g=function(e=u.search.page){u.search.page=e;let t=(e-1)*u.search.resultsPerPage,r=e*u.search.resultsPerPage;// 0
return u.search.results.slice(t,r)},f=function(e){u.recipe.ingredients.forEach(t=>{t.quantity=t.quantity*e/u.recipe.servings;// newQT = OldQT * newServings / oldServings // 2 * 8 / 4 = 4
...
if(3!==t.length)throw Error("not correct Form of INGRIDIENTS!");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,publisher:e.publisher,source_url:e.sourceUrl,image_url:e.image,servings:+e.servings,cooking_time:+e.cookingTime,ingredients:t},n=await l(`${s}?key=${c}`,r);u.recipe=d(n),v(u.recipe)}catch(e){throw e}};var b={};b=new URL(a("27Lyk").resolve("eyyUD"),import.meta.url).toString();class w{_data;render(e,t=!0){if(!e||Array.isArray(e)&&0===e.length)return this.renderError();this._data=e;let r=this._generateMarkup();if(!t)return r;this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",r)}update(e){this._data=e;let t=this._generateMarkup(),r=document.createRange().createContextualFragment(t),n=Array.from(r.querySelectorAll("*")),i=Array.from(this._parentElement.querySelectorAll("*"));n.forEach((e,t)=>{let r=i[t];e.isEqualNode(r)||e.firstChild?.nodeValue.trim()===""||(r.textContent=e.textContent),e.isEqualNode(r)||Array.from(e.attributes).forEach(e=>r.setAttribute(e.name,e.value))})}_clear(){this._parentElement.innerHTML=""}renderSpinner(){let e=`
        <div class="spinner">
            <svg>
...
1===r&&e>1?`
      ...
      `:"")}}var I=new N;const D=async function(){try{let e=window.location.hash.slice(1);if(!e)return;L.renderSpinner(),M.update(g()),T.update(u.bookmarks),// 2. Loading Recipe
await h(e),L.render(u.recipe)}catch(e){L.renderError(),console.log(e)}},R=async function(){try{M.renderSpinner();// 1. Get Search Query
let e=S.getQuery();if(!e)return;// 2. Load Search Results
await p(e),M.render(g()),I.render(u.search)}catch(e){console.log(e)}},A=async function(e){try{q.renderSpinner(),// Upload New recipe data
await y(e),console.log(u.recipe),L.render(u.recipe),q.renderMessage(),T.render(u.bookmarks),// Change id in URL
window.history.pushState(null,"",`#${u.recipe.id}`),// Closing Form window
setTimeout(function(){q.toggleWindow()},2500)}catch(e){console.error(e,"\uD83D\uDE00\uD83D\uDE00\uD83D\uDE00"),q.renderError(e.message)}};T.addHandlerRender(function(){T.render(u.bookmarks)}),L.addHandlerRender(D),L.addHandlerUpdateServings(function(e){//Update recipe servings
f(e),L.update(u.recipe)}),L.addHandlerBookmark(function(){u.recipe.bookmarked?m(u.recipe.id):v(u.recipe),L.update(u.recipe),T.render(u.bookmarks)}),S.addHandlerSearch(R),I.addHandlerRender(function(e){M.render(g(e)),I.render(u.search)}),q.addHandlerUpload(A);// 28:30 024
//# sourceMappingURL=index.15e6aaf9.js.map
